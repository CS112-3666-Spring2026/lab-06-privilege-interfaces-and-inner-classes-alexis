public class Person implements Comparable<Person> {
	...
	/***** PART 2: Helper Inner Class for Identity *****/
	...
	public static final String DEFAULT_BACKGROUND =
			"I am Latinx and work as a tutor at the tutoring center on campus";
	...
	public Person() {
		this(DEFAULT_NAME, DEFAULT_PRONOUNS,
				DEFAULT_BACKGROUND, DEFAULT_PRIVILEGE);
	}

	public Person(Person original) {
		if (original == null) {
			throw new IllegalArgumentException(
					"Cannot copy null object in Person copy constructor");
		}

		this.setAll(original.name,
				original.story.pronouns,
				original.story.background,
				original.privilege);
	}
	...
	public void setAll(String name, String pronouns,
					   String background, int privilege) {
		this.setName(name);
	...
	public String toString() {
		return "My name is " + this.name + ", "
				+ this.story + "\n"
				+ "According to this calculator I ended up with "
				+ this.privilege + " estimated privilege points";
	}
	...
	public boolean equals(Object other) {
		...
		return this.name.equals(otherPerson.name)
				&& this.story.equals(otherPerson.story)
				&& this.privilege == otherPerson.privilege;
	}

	/***** PART 1: Comparable Interface Method *****/
	@Override
	public int compareTo(Person other) {

		if (other == null) {
			throw new IllegalArgumentException(
					"Null given to compareTo in Person");
		}
